...
3. Find you Game Id through the games menu in the Autofire Dashboard.
4. Fire the startSession event immediately after your game loads, using your game's Id and Version.
5. Fire the finishSession event when you game ends or the player quits.
...
These two lines of code are all you need to get started:
	...
	// fire the finishSession event when you game ends or the player quits
...
- the events you see in the example are further explained later, but for the purposes of this example their usage is self explanatory.
...
Autofire - Game Analytics | copyright 2016 | <http://autofire.io>